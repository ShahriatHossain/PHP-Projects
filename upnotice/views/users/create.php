...
<section class="charts">
    <div class="container-fluid">
        <form method="post" action="?controller=manageusers&action=create">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="role_id" name="role_id">
                <?php foreach($roles as $role){?>
                  <option value="<?php echo $role->id?>" <?php if($role->name == $validObj->role)echo'selected="selected"'?>><?php echo $role->name?></option>
                <?php }?>
              </select>
